    ...
    <div class="dieHomeBig">
      ...
      <div class="dieContent">
        ...
        <div class="buttonDown">
          <div class="buttonDown__content">You declined the invitation</div>
        </div>
      </div>
...
.iconOrange {
  width: 40px;
  height: 60px;
  background: no-repeat center center url('../assets/img/profileView/Ellipse33.svg');
  margin-left: 10px;
